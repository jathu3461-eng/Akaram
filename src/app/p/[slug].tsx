...
const staticContent: Record<string, { title: string; content: string }> = {
  about: {
    title: 'About Us',
    content: 'Akaram is the premier web directory and community hub for Tamil Canadians. Founded with the mission to connect culture, community, and business, we provide a centralized platform for discovering local businesses, upcoming events, news, and more.\n\nOur goal is to support local entrepreneurs and preserve our rich cultural heritage across Canada.',
  },
  privacy: {
